"""Train an FFM model on TFRecord samples."""
...
from gerbil_train.models.ffm import FFM
from gerbil_train.trainer.ffm_trainer import FFMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/1-ffm/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "ffm")
    ...
    trainer = FFMTrainer(model, train_cfg, data_cfg)
