"""Train a SLIM model on TFRecord samples."""
...
from gerbil_train.models.slim import SLIM
from gerbil_train.trainer.slim_trainer import SLIMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/1-slim/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "slim")
    ...
    trainer = SLIMTrainer(model, train_cfg, data_cfg)
...
# python3 -m gerbil_train.cli.1-slim_train --config configs/1-slim/experiment.yaml
