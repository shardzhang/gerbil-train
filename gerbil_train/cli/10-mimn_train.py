"""Train a MIMN model on TFRecord samples."""
...
from gerbil_train.models.mimn import MIMN
from gerbil_train.trainer.mimn_trainer import MIMNTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/10-mimn/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "mimn")
    ...
    trainer = MIMNTrainer(model, train_cfg, data_cfg)
