"""Train a SIM model on TFRecord samples."""
...
from gerbil_train.models.sim import SIM
from gerbil_train.trainer.sim_trainer import SIMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/11-sim/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "sim")
    ...
    trainer = SIMTrainer(model, train_cfg, data_cfg)
