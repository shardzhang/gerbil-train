"""Train a BST model on TFRecord samples."""
...
from gerbil_train.models.bst import BST
from gerbil_train.trainer.bst_trainer import BSTTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/13-bst/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "bst")
    ...
    trainer = BSTTrainer(model, train_cfg, data_cfg)
