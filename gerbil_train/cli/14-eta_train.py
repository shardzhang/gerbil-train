"""Train an ETA model on TFRecord samples."""
...
from gerbil_train.models.eta import ETA
from gerbil_train.trainer.eta_trainer import ETATrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/14-eta/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "eta")
    ...
    trainer = ETATrainer(model, train_cfg, data_cfg)
