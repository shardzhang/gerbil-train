"""Train an SDIM model on TFRecord samples."""
...
from gerbil_train.models.sdim import SDIM
from gerbil_train.trainer.sdim_trainer import SDIMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/15-sdim/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "sdim")
    ...
    trainer = SDIMTrainer(model, train_cfg, data_cfg)
