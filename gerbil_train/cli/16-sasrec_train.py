"""Train a SASRec model on TFRecord samples."""
...
from gerbil_train.models.sasrec import SASRec
from gerbil_train.trainer.sasrec_trainer import SASRecTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/16-sasrec/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "sasrec")
    ...
    trainer = SASRecTrainer(model, train_cfg, data_cfg)
