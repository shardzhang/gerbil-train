"""Train a BERT4Rec model on TFRecord samples."""
...
from gerbil_train.models.bert4rec import BERT4Rec
from gerbil_train.trainer.bert4rec_trainer import BERT4RecTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/17-bert4rec/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "bert4rec")
    ...
    trainer = BERT4RecTrainer(model, train_cfg, data_cfg)
