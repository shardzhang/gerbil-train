"""Train an ESMM model on TFRecord samples."""
...
from gerbil_train.models.esmm import ESMM
from gerbil_train.trainer.esmm_trainer import ESMMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/20-esmm/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "esmm")
    ...
    trainer = ESMMTrainer(model, train_cfg, data_cfg)
