"""Train an MMoE model on TFRecord samples."""
...
from gerbil_train.models.mmoe import MMoE
from gerbil_train.trainer.mmoe_trainer import MMoETrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/21-mmoe/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "mmoe")
    ...
    trainer = MMoETrainer(model, train_cfg, data_cfg)
