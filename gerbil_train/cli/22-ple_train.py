"""Train a PLE model on TFRecord samples."""
...
from gerbil_train.models.ple import PLE
from gerbil_train.trainer.ple_trainer import PLETrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/22-ple/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "ple")
    ...
    trainer = PLETrainer(model, train_cfg, data_cfg)
