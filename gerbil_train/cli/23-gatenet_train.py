"""Train a GateNet model on TFRecord samples."""
...
from gerbil_train.models.gatenet import GateNet
from gerbil_train.trainer.gatenet_trainer import GateNetTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/23-gatenet/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "gatenet")
    ...
    trainer = GateNetTrainer(model, train_cfg, data_cfg)
