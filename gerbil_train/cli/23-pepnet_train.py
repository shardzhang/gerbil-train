"""Train a PEPNet model on TFRecord samples."""
...
from gerbil_train.models.pepnet import PEPNet
from gerbil_train.trainer.pepnet_trainer import PEPNetTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/23-pepnet/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "pepnet")
    ...
    trainer = PEPNetTrainer(model, train_cfg, data_cfg)
