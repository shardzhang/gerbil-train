"""Train an AdaTT model on TFRecord samples."""
...
from gerbil_train.models.adatt import AdaTT
from gerbil_train.trainer.adatt_trainer import AdaTTTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/24-adatt/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "adatt")
    ...
    trainer = AdaTTTrainer(model, train_cfg, data_cfg)
