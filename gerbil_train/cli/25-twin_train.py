"""Train a TWIN model on TFRecord samples."""
...
from gerbil_train.models.twin import TWIN
from gerbil_train.trainer.twin_trainer import TWINTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/25-twin/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "twin")
    ...
    trainer = TWINTrainer(model, train_cfg, data_cfg)
