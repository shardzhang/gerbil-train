"""Train an NFM model on TFRecord samples."""
...
from gerbil_train.models.nfm import NFM
from gerbil_train.trainer.nfm_trainer import NFMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/3-nfm/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "nfm")
    ...
    trainer = NFMTrainer(model, train_cfg, data_cfg)
