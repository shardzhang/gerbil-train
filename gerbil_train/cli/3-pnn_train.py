"""Train a PNN model on TFRecord samples."""
...
from gerbil_train.models.pnn import PNN
from gerbil_train.trainer.pnn_trainer import PNNTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/3-pnn/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "pnn")
    ...
    trainer = PNNTrainer(model, train_cfg, data_cfg)
