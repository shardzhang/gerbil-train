"""Train an EGES model on TFRecord samples."""
...
from gerbil_train.models.eges import EGES
from gerbil_train.trainer.eges_trainer import EGESTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/31-eges/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "eges")
    ...
    trainer = EGESTrainer(model, train_cfg, data_cfg)
