"""Train a Word2Vec model on TFRecord samples."""
...
from gerbil_train.models.word2vec import Word2Vec
from gerbil_train.trainer.word2vec_trainer import Word2VecTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/32-word2vec/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "word2vec")
    ...
    trainer = Word2VecTrainer(model, train_cfg, data_cfg)
