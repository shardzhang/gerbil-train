"""Train an xDeepFM model on TFRecord samples."""
...
from gerbil_train.models.xdeepfm import xDeepFM
from gerbil_train.trainer.deepfm_trainer import DeepFMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/5-xdeepfm/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "xdeepfm")
