"""Train a DCN model on TFRecord samples."""
...
from gerbil_train.models.dcn import DCN
from gerbil_train.trainer.dcn_trainer import DCNTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/6-dcn/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "dcn")
    ...
    trainer = DCNTrainer(model, train_cfg, data_cfg)
