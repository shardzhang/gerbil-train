"""Train a DCNv2 model on TFRecord samples."""
...
from gerbil_train.models.dcnv2 import DCNv2
from gerbil_train.trainer.dcnv2_trainer import DCNv2Trainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/6-dcnv2/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "dcnv2")
    ...
    trainer = DCNv2Trainer(model, train_cfg, data_cfg)
