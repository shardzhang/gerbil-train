"""Train a DLRM model on TFRecord samples."""
...
from gerbil_train.models.dlrm import DLRM
from gerbil_train.trainer.dlrm_trainer import DLRMTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/6-dlrm/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "dlrm")
    ...
    trainer = DLRMTrainer(model, train_cfg, data_cfg)
