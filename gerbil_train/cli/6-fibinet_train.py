"""Train a FiBiNet model on TFRecord samples."""
...
from gerbil_train.models.fibinet import FiBiNet
from gerbil_train.trainer.fibinet_trainer import FiBiNetTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/6-fibinet/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "fibinet")
    ...
    trainer = FiBiNetTrainer(model, train_cfg, data_cfg)
