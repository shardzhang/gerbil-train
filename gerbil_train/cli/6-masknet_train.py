"""Train a MaskNet model on TFRecord samples."""
...
from gerbil_train.models.masknet import MaskNet
from gerbil_train.trainer.masknet_trainer import MaskNetTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/6-masknet/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "masknet")
    ...
    trainer = MaskNetTrainer(model, train_cfg, data_cfg)
