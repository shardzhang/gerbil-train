"""Train a STAR model on TFRecord samples."""
...
from gerbil_train.models.star import STAR
from gerbil_train.trainer.star_trainer import STARTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/6-star/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "star")
    ...
    trainer = STARTrainer(model, train_cfg, data_cfg)
