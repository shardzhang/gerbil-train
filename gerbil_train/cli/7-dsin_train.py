"""Train a DSIN model on TFRecord samples."""
...
from gerbil_train.models.dsin import DSIN
from gerbil_train.trainer.dsin_trainer import DSINTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/7-dsin/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "dsin")
    ...
    trainer = DSINTrainer(model, train_cfg, data_cfg)
