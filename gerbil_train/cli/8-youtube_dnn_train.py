...
CONFIG_PATH = PROJECT_ROOT / "configs/8-youtube_dnn/experiment.yaml"
...
# python3 -m gerbil_train.cli.8-youtube_dnn_train --config configs/8-youtube_dnn/experiment.yaml
