"""Train a BPR model on TFRecord samples."""
...
from gerbil_train.models.bpr import BPR
from gerbil_train.trainer.bpr_trainer import BPRTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/99-bpr/experiment.yaml"
...
def main() -> None:
    ...
    trainer = BPRTrainer(model, train_cfg, data_cfg)
