"""Train an MV-DNN model on TFRecord samples."""
...
from gerbil_train.models.mvdnn import MVDNN
from gerbil_train.trainer.mvdnn_trainer import MVDNNTrainer

PROJECT_ROOT = Path(__file__).parent.parent.parent
CONFIG_PATH = PROJECT_ROOT / "configs/99-mvdnn/experiment.yaml"
...
def main() -> None:
    ...
    run_dir = create_run_dir(PROJECT_ROOT / "checkpoints" / "mvdnn")
    ...
    trainer = MVDNNTrainer(model, train_cfg, data_cfg)
