"""Trainer for FiBiNet (Feature Importance and Bilinear Interaction Network) models."""
...
__all__ = ["FiBiNetTrainer"]


class FiBiNetTrainer(BinaryClassificationTrainer):
