"""Trainer for Wide & Deep binary classification models."""
...
__all__ = ["WideAndDeepTrainer"]


class WideAndDeepTrainer(BinaryClassificationTrainer):
